package com.jornada.client.framework;
...
//    public static void it(String docType, Element htmlTitle, String style, UIObject obj) {
//        it(docType, htmlTitle, style, obj.getElement());
//    }

    public static void it(String style, Element elementTitle, Element element) {
        it("", style, elementTitle, element);
    }

    public static void it(String docType, String style, Element elementTitle, Element element) {
        saveOrigIFrames(element);
        updateFieldsDOM(element);
        it(docType, style, DOM.toString(elementTitle), DOM.toString(element));
    }

    public static void it(String docType, String style, String htmlTitle, String it) {
    	
    	style = style.replace("href='", "href='"+GWT.getHostPageBaseURL()+"");    	
    	it = it.replace("<img src=\"images", "<img src=\""+GWT.getHostPageBaseURL()+"images");
        it(docType
           +"<html>"
           +"<head>"
