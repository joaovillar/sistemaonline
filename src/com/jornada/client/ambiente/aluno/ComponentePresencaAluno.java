...
public class ComponentePresencaAluno extends Composite{

	static TextConstants txtConstants = GWT.create(TextConstants.class);
	
    private static ComponentePresencaAluno uniqueInstance;
	
	public static ComponentePresencaAluno getInstance(){
		if(uniqueInstance==null){
			uniqueInstance = new ComponentePresencaAluno();
		}
		return uniqueInstance;
	}	
	
	private ComponentePresencaAluno(){
