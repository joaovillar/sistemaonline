...
public class TabelaAlunoComunicado extends VerticalPanel {
	...
	public static TabelaAlunoComunicado getInstance(
			TelaInicialAlunoComunicado telaInicialAlunoComunicado) {
		if (uniqueInstance == null) {
			uniqueInstance = new TabelaAlunoComunicado(
					telaInicialAlunoComunicado);
		}
		return uniqueInstance;
	}

	private TabelaAlunoComunicado(
			TelaInicialAlunoComunicado telaInicialAlunoComunicado) {
		...
		cellTable.setWidth(Integer
				.toString(TelaInicialAlunoComunicado.intWidthTable) + "px");
	...
	public void openTabelaComunicados() {
		...
		scrollPanel
				.setSize(
						Integer.toString(TelaInicialAlunoComunicado.intWidthTable + 30)
								+ "px",
