...
public class TelaInicialAvaliacao extends Composite{
	...
	private TelaInicialAvaliacao(MainView mainView) {
		...
		stackPanel.add(adicionarAvaliacao, new MpHeaderWidget(txtConstants.avaliacaoAdicionar(), "images/plus-circle.png"));
		stackPanel.add(editarAvaliacao, new MpHeaderWidget(txtConstants.avaliacaoEditar(), "images/comment_edit.png"));		
