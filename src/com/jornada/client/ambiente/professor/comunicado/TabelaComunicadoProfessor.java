...
public class TabelaComunicadoProfessor extends VerticalPanel {
	...
	TelaInicialComunicadoProfessor telaInicialComunicadoProfessor;

	private static TabelaComunicadoProfessor uniqueInstance;
	DetalhesComunicadoProfessor detalhesComunicadoProfessor;

	public static TabelaComunicadoProfessor getInstance(
			TelaInicialComunicadoProfessor telaInicialComunicadoProfessor) {
		if (uniqueInstance == null) {
			uniqueInstance = new TabelaComunicadoProfessor(
					telaInicialComunicadoProfessor);
		}
		return uniqueInstance;
	}

	private TabelaComunicadoProfessor(
			TelaInicialComunicadoProfessor telaInicialComunicadoProfessor) {
		...
		// MpImageButton btnAdicionarComunicado = new
		...
		cellTable.setWidth(Integer
				.toString(TelaInicialComunicadoProfessor.intWidthTable) + "px");
	...
	public void openComunicadoDetalhe(Comunicado object) {
		detalhesComunicadoProfessor = new DetalhesComunicadoProfessor(object);
		vPanelBody.clear();
		...
		vPanelBody.add(detalhesComunicadoProfessor);
	...
	public void openTabelaComunicados() {
		...
		scrollPanel
				.setSize(
						Integer.toString(TelaInicialComunicadoProfessor.intWidthTable + 30)
								+ "px",
	...
	private void initTableColumns(
			final SelectionModel<Comunicado> selectionModel) {

		Column<Comunicado, String> imageColumn = new Column<Comunicado, String>(
				new MyImageCellView()) {
			@Override
		...
		// Column<Comunicado, String> editColumn = new Column<Comunicado,
		// String>(new MyImageCellEdit()) {
		// @Override
		// public String getValue(Comunicado object) {
		...
		// };
		//
		// Column<Comunicado, String> removeColumn = new Column<Comunicado,
		// String>(new MyImageCellDelete()) {
		// @Override
		// public String getValue(Comunicado object) {
