...
//	private AsyncCallback<Boolean> callbackDeleteComunicado;
	...
	public static TabelaComunicadoProfessor getInstance(TelaInicialComunicadoProfessor telaInicialComunicadoProfessor){
		if(uniqueInstance==null){
			uniqueInstance = new TabelaComunicadoProfessor(telaInicialComunicadoProfessor);
		}
		return uniqueInstance;
	}	
	
	private TabelaComunicadoProfessor(TelaInicialComunicadoProfessor telaInicialComunicadoProfessor){
