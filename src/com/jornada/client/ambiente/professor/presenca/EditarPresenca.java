...
public class EditarPresenca extends VerticalPanel {
...
//	private int intCount=0;
	...
	public EditarPresenca(final TelaInicialPresenca telaInicialDiarioProfessor) {
...
//		scrollPanel.setSize(Integer.toString(TelaInicialDiarioProfessor.intWidthTable)+"px",Integer.toString(TelaInicialDiarioProfessor.intHeightTable-210)+"px");
		scrollPanel.setHeight(Integer.toString(TelaInicialPresenca.intHeightTable-210)+"px");
