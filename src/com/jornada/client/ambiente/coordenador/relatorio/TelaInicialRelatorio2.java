...
public class TelaInicialRelatorio2 extends Composite {
...
//	ComponenteTopico componenteTopico;
	...
	private static TelaInicialRelatorio2 uniqueInstance;
	public static TelaInicialRelatorio2 getInstance(MainView mainView){		
		if(uniqueInstance==null){
			uniqueInstance = new TelaInicialRelatorio2(mainView);
		}		
		return uniqueInstance;
	}	

	private TelaInicialRelatorio2(MainView mainView) {
