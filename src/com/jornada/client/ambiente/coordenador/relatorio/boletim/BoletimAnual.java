...
import com.jornada.client.ambiente.coordenador.relatorio.boletim.dialog.MpDialogBoxMultipleBoletimAnual;
...
public class BoletimAnual extends VerticalPanel {
	...
	private TelaInicialBoletim telaInicialPeriodo;
	...
	private static BoletimAnual uniqueInstance;
	
	public static BoletimAnual getInstance(final TelaInicialBoletim telaInicialRelatorio){

		if(uniqueInstance==null){
			uniqueInstance = new BoletimAnual(telaInicialRelatorio);
		}
	...
	private BoletimAnual(final TelaInicialBoletim telaInicialRelatorio) {
...
//		MpLabelRight lblPeriodo = new MpLabelRight(txtConstants.periodo());
		...
		flexTable.setWidget(row, 2, mpHelperCurso);flexTable.setWidget(row++, 3, mpLoading);
