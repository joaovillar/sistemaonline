...
public class DialogBoxHistoricoAluno extends DecoratedPopupPanel {
...
//	MpDialogBox mpDialogBoxConfirm = new MpDialogBox();
	...
	private static DialogBoxHistoricoAluno uniqueInstance;
	
	public static DialogBoxHistoricoAluno getInstance(int idCurso, int idUsuario, String strNomeCurso, String strNomeDisciplina, Double mediaNotaCurso){
		if(uniqueInstance==null){
			uniqueInstance = new DialogBoxHistoricoAluno();
		}else{
		    uniqueInstance.vBody.clear();
		}
        uniqueInstance.showDialog(idCurso, idUsuario, strNomeCurso, strNomeDisciplina, mediaNotaCurso);
	...
	protected DialogBoxHistoricoAluno(){
    ...
    protected void showDialog(int idCurso, int idUsuario, String strNomeCurso, String strNomeDisciplina, Double mediaNotaCurso) {
...
//        cellTable.addColumn(disciplinaColumn, txtConstants.disciplina());
    ...
    public void initSortHandler(ListHandler<AvaliacaoNota> sortHandler) {
        ...
        pesoNotaColumn.setSortable(true);
        sortHandler.setComparator(pesoNotaColumn, new Comparator<AvaliacaoNota>() {
            @Override
            public int compare(AvaliacaoNota o1, AvaliacaoNota o2) {
        ...
        sortHandler.setComparator(notaColumn, new Comparator<AvaliacaoNota>() {
            @Override
            public int compare(AvaliacaoNota o1, AvaliacaoNota o2) {
                
                String boo1 = Double.toString(o1.getNota());
                String boo2 = Double.toString(o2.getNota());
    ...
    private class ClickHandlerFechar implements ClickHandler {
        public void onClick(ClickEvent event) {
            DialogBoxHistoricoAluno.this.hide();
        }
    }
