...
import com.jornada.client.ambiente.coordenador.relatorio.boletim.dialog.MpDialogBoxMultipleBoletimPeriodo;
...
public class BoletimPeriodo extends VerticalPanel {
	...
	public static BoletimPeriodo getInstance(final TelaInicialBoletim telaInicialRelatorio){
	...
	private BoletimPeriodo(final TelaInicialBoletim telaInicialRelatorio) {
...
//        btnFiltrar.addClickHandler(new ClickHandlerFiltrar());
        ...
        flexTableSearch.setBorderWidth(0);
...
//        flexTableMenu.setWidget(0, 0, mpPager);
        ...
        flexTableMenu.getCellFormatter().setWidth(0, 0, "80%");
...
//            initializeCellTable();        
    ...
    private class ClickHandlerMultipleExcel implements ClickHandler {
        ...
        public void onClick(ClickEvent event) {
            MpDialogBoxMultipleBoletimPeriodo.getInstance();
        }
    }
