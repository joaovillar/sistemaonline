...
//    private Usuario usuarioLogado;
    ...
    public static HistoricoAluno getInstance(final TelaInicialBoletim telaInicialRelatorio) {
    ...
    private HistoricoAluno(final TelaInicialBoletim telaInicialRelatorio) {
