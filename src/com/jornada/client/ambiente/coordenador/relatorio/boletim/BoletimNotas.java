...
import com.jornada.client.ambiente.coordenador.relatorio.boletim.dialog.MpDialogBoxMultipleBoletimNotas;
...
public class BoletimNotas extends VerticalPanel {
    ...
    public static BoletimNotas getInstance(final TelaInicialBoletim telaInicialRelatorio) {
    ...
    private BoletimNotas(final TelaInicialBoletim telaInicialRelatorio) {
