...
import com.jornada.client.ambiente.coordenador.relatorio.boletim.dialog.MpDialogBoxMultipleBoletimDisciplina;
...
public class BoletimDisciplina extends VerticalPanel {
    ...
    public static BoletimDisciplina getInstance(final TelaInicialBoletim telaInicialRelatorio) {
    ...
    private BoletimDisciplina(final TelaInicialBoletim telaInicialRelatorio) {
