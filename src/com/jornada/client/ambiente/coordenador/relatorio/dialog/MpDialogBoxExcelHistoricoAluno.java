...
public class MpDialogBoxExcelHistoricoAluno extends DecoratedPopupPanel implements ClickListener {

	static TextConstants txtConstants = GWT.create(TextConstants.class);
	
	MpPanelLoading mpPanelLoading = new MpPanelLoading("images/radar.gif");
	
	private static MpDialogBoxExcelHistoricoAluno uniqueInstance;
	
	Grid grid;
	Anchor anchor;
	
	
    public static MpDialogBoxExcelHistoricoAluno getInstance(int idCurso, int idAluno) {

        if (uniqueInstance == null) {
            uniqueInstance = new MpDialogBoxExcelHistoricoAluno();
        } 
        uniqueInstance.showDialog();
        uniqueInstance.generateExcelHistoricoAluno(idCurso, idAluno);
	...
	private MpDialogBoxExcelHistoricoAluno() {
...
//		setWidget(dock);
    ...
    private void generateExcelHistoricoAluno(int idCurso, int idAluno) {
        GWTServiceNota.Util.getInstance().getExcelHistoricoAluno(idCurso, idAluno,  new CallBackBoletim());
    }
