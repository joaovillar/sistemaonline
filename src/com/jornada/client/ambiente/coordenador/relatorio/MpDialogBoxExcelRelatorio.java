...
public class MpDialogBoxExcelRelatorio extends DecoratedPopupPanel implements ClickListener {

	static TextConstants txtConstants = GWT.create(TextConstants.class);
	
	MpPanelLoading mpPanelLoading = new MpPanelLoading("images/radar.gif");
	
	private static MpDialogBoxExcelRelatorio uniqueInstance;
	
	Grid grid;
	Anchor anchor;
	
	public static MpDialogBoxExcelRelatorio getInstance(int idCurso, int idPeriodo){
		
		if(uniqueInstance==null){
			uniqueInstance = new MpDialogBoxExcelRelatorio();
			uniqueInstance.showDialog(idCurso, idPeriodo);
		}else{
			uniqueInstance.showDialog(idCurso, idPeriodo);
		}
	...
	private MpDialogBoxExcelRelatorio() {
	...
	private void showDialog(int idCurso, int idPeriodo) {
...
//		setWidget(dock);
		...
		GWTServiceNota.Util.getInstance().getExcelBoletimPeriodo(idCurso, idPeriodo, new AsyncCallback<String>() {
