...
public abstract class MpHierarquiaCurso extends Composite{
	...
	protected TextConstants txtConstants;
...
//		flexTableConteudo.getColumnFormatter().setWidth(1, "200px");
//		flexTableConteudo.getColumnFormatter().setWidth(2, "150px");
//		flexTableConteudo.getFlexCellFormatter().setColSpan(1, 0, 4);
//		flexTableConteudo.getFlexCellFormatter().setColSpan(3, 0, 4);
		int row=0;
...
//		flexTableConteudo.setWidget(row++, 0, lblMediaNotaCurso);
//		flexTableConteudo.setWidget(row++, 0, lblMediaNotaCursoDB);
//		flexTableConteudo.setWidget(row++, 0, new MpSpacePanel());
//		flexTableConteudo.setWidget(row++, 0, lblPorcentagemPresencaCurso);
//		flexTableConteudo.setWidget(row++, 0, lblPorcentagemPresencaCursoDB);
		flexTableConteudo.setWidget(row++, 0, new MpSpacePanel());		
		
//		flexTableConteudo.setWidget(row, 0, lblDataInicialCurso);flexTableConteudo.setWidget(row, 1, lblDataInicialCursoDB);
//		flexTableConteudo.setWidget(row, 2, lblDataFinalCurso);flexTableConteudo.setWidget(row++, 3, lblDataFinalCursoDB);
