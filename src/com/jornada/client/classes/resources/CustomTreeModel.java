...
public class CustomTreeModel implements TreeViewModel{
    ...
    public CustomTreeModel(ArrayList<Curso> listCursos, SelectionModel<Object> selectionModelObject) {
	...
	if (value == null) {
		...
		ListDataProvider<Curso> dataProvider = new ListDataProvider<Curso>(listCursos);

		Cell<Curso> cell = new AbstractCell<Curso>() {
			@Override
			public void render(Context context, Curso value, SafeHtmlBuilder sb) {
				if (value != null) {
		...
		return new DefaultNodeInfo<Curso>(dataProvider, cell, selectionModelObject, null);
