 ...
 */
public class MpTextAreaInputCell extends AbstractInputCell<String, MpTextAreaInputCell.ViewData> {

    interface Template extends SafeHtmlTemplates {
        @Template("<textarea type=\"text\" cols=\"60\" rows=\"15\" class=\"design_text_boxes\" tabindex=\"-1\">{0}</textarea>")
