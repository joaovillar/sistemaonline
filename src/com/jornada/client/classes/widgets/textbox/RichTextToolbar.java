...
//		bottomPanel.setStyleName(CSS_ROOT_NAME);
		...
		grid.setStyleName("design_light_gray_background");
		grid.setCellSpacing(1);
		grid.setCellPadding(1);
		{
			int i = 0;
			grid.setWidget(0, i++, listBoxPanel);
			grid.setWidget(0, i++, buttonsPanel);
		...
		styleText = richtext;
		styleText.setStyleName("design_text_rich_boxes");
		styleTextFormatter = styleText.getFormatter();

		//Set some graphical options, so this toolbar looks how we like it.
		buttonsPanel.setHorizontalAlignment(HorizontalPanel.ALIGN_LEFT);
//		topPanel.setStyleName("design_light_gray_background");
		listBoxPanel.setHorizontalAlignment(HorizontalPanel.ALIGN_LEFT);
...
//		topPanel.add(new HTML("&nbsp;"));
		...
		listBoxPanel.add(fontlist = createFontList());
		listBoxPanel.add(new HTML("&nbsp;"));
		listBoxPanel.add(colorlist = createColorList());
	}
	...
	private ListBox createFontList() {
	    ...
	    mylistBox.setStyleName("design_text_boxes");
