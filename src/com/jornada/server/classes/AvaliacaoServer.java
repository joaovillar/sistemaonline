...
public class AvaliacaoServer {
    ...
    public static ArrayList<Avaliacao> getAvaliacao(int idDisciplina) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                current.setTipoAvaliacao(AvaliacaoServer.getTipoAvaliacao(current.getIdTipoAvaliacao()));
    ...
    public static TipoAvaliacao getTipoAvaliacao(String strNomeTipoAvaliacao) {
        ...
        try {
            ...
            // dataBase.createConnection();
            PreparedStatement ps = conn.prepareStatement(AvaliacaoServer.DB_SELECT_TIPO_AVALIACAO_NOME);

            int count = 0;
            ps.setString(++count, strNomeTipoAvaliacao);
